  ...
  "inline-flex items-center rounded-md border border-neutral-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:border-neutral-800 dark:focus:ring-neutral-300",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-transparent bg-red-600 text-neutral-50 shadow hover:bg-red-500/80 dark:bg-red-900 dark:text-neutral-50 dark:hover:bg-red-900/80",
        outline: "text-neutral-950 dark:text-neutral-50",
        pending: 'bg-yellow-400 text-white hover:bg-yellow-400/80',
        success: 'bg-green-400 text-white hover:bg-green-400/80',
        warning: 'bg-orange-400 text-white hover:bg-orange-400/80',
        info: 'bg-blue-400 text-white hover:bg-blue-400/80',
      },
    },
    defaultVariants: {
      variant: "default",
